--========================================================
-- QENTURY HUB v4.1-tes — Mine a Mountain
...
local Window = Library:CreateWindow({
	...
	Footer = "Qentury Hub v4.1-tes123",
	NotifySide = "Right",
...
FavLuckBox:AddSlider("FavLuckMin", {
	...
	Max = 500,
	Rounding = 1,
	Tooltip = "Favorite tools with luck > this percent (hub formula). Max 500%.",
	Callback = function(v)
		state.favLuckMin = v
	end,
})
...
Library:Notify({
	Title = "Mine a Mountain",
	Description = "Qentury Hub v4.1-tes · loading extras…",
	Time = 4,
})
